...
def read_json_to_dataframe(input_file):
    """
    Reads a JSON file and converts it to a Pandas DataFrame then cleans the data by removing any rows where duration is missing.
    Args:        input_file (str): The path to the JSON file to read.
    Returns:     pd.DataFrame: A DataFrame containing the data from the JSON file.
    Raises:      ValueError: If the JSON file cannot be read or is not in the expected format.
    """
